...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table orders(id int primary key,buy_id int references users(id),seller_b_id int references seller_book (id),price int,date text,status varchar(255))");
        ...
        db.execSQL("INSERT into orders(id,buy_id,seller_b_id,price,date,status) values (1,1,1,200,'2020-07-10','SOLD');");
